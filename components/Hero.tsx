      ...
      <div className="relative z-10 text-center px-4 max-w-5xl">
        ...
        >
          ...
          <h1 className="text-6xl md:text-9xl font-syncopate font-bold leading-none mb-8 tracking-tighter">
            GLOBAL <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-500 neon-text-pink">SOUND</span>
          </h1>
        </motion.div>
        ...
        >
          <a href="#booking" className="w-full md:w-auto px-10 py-5 bg-pink-600 hover:bg-pink-500 text-white font-bold rounded-full transition-all flex items-center justify-center gap-2 tracking-widest shadow-[0_0_20px_rgba(255,0,255,0.4)]">
            BOOK DJ CUPPY
          </a>
          <a href="#media" className="w-full md:w-auto px-10 py-5 bg-white/10 hover:bg-white/20 backdrop-blur-md text-white font-bold rounded-full border border-white/20 transition-all flex items-center justify-center gap-2 tracking-widest">
